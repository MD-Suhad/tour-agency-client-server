...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.tqwi4.mongodb.net/myFirstDatabase?retryWrites=true&w=majority`;
console.log(PASS);
...
async function run() {
  try {
    ...
    const database = client.db("Travel-Agency-server");
